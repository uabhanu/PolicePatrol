...
public class PoliceController : MonoBehaviour 
{
	...
	{
		m_policeBody2D.velocity = new Vector2(0f , rigidbody2D.velocity.y);
	...
	public void PerformCrouchWalk()
	{
		...
		if(m_isCrouchMovingRight)
		{
			...
			m_policeBody2D.velocity = new Vector2(m_walkSpeed , rigidbody2D.velocity.y);
		}
	...
	public void PerformRun()
	{
		...
		if (m_isMovingRight)
		{
			...
			m_policeBody2D.velocity = new Vector2(m_runSpeed , rigidbody2D.velocity.y);
		}
