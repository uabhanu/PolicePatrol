...
public class Thug : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		if(m_floor == "Odd")
		{
			...
			m_thugBody2D.transform.Rotate(0 , 0 , 0);
		}
	}
	#endregion
	...
	void PerformAttack()
	{
		...
		m_thugBody2D.velocity = new Vector2(0f , rigidbody2D.velocity.y);
	...
	void PerformAttacking()
	{
		...
		if (m_isMovingRight)
		{
			...
			m_thugBody2D.velocity = new Vector2(m_moveSpeed , rigidbody2D.velocity.y);
		}
