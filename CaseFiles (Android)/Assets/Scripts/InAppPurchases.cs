...
namespace Soomla.Store.Chimping 
{
	public class InAppPurchases : IStoreAssets 
	{
		...
		{
			return new VirtualGood[] {MUFFINCAKE_GOOD, PAVLOVA_GOOD,CHOCLATECAKE_GOOD, CREAMCUP_GOOD, NO_ADS_LTVG/*, T_3_B*/};
		}
		...
		public const string THE_3_BROTHERS_PRODUCT_ID = "all_in_one";
...
//		public static VirtualGood T_3_B = new LifetimeVG
//		{
//			"Get it All",
//			"All Levels & No Ads",
//			"all_in_one",
//			new PurchaseWithMarket(THE_3_BROTHERS_PRODUCT_ID , 0.99)
//		};
	}
}
